<template>
    ...
    <div class="home-swiper">
        ...
        <div class="home-swiper__swipe">
            <swiper :slides-per-view="1" :modules="modules" :pagination="{ clickable: true }" :autoplay="{delay: 300}"
                    :grab-cursor="true"
                    class="swiper">
                <swiper-slide>
                ...
                <swiper-slide>
                    <img src="../../assets/img/homeImages/10.png" alt="man">
                </swiper-slide>

                <swiper-slide>
                    <img src="../../assets/img/homeImages/4.png" alt="man">
                </swiper-slide>

                <swiper-slide>
                    <img src="../../assets/img/homeImages/6.png" alt="man">
                </swiper-slide>
            </swiper>
